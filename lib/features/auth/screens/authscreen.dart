...
class _AuthScreenState extends State<AuthScreen> {
 final _signUpFormKey = GlobalKey<FormState>();
  ...
  final TextEditingController _nameController = TextEditingController();
   Auth _auth = Auth.signup;// for default valuel
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Create Acccout',style:  TextStyle(fontWeight: FontWeight.bold  ),),
...
signUpUser();
            ...
            ListTile(
              ...
              leading: Radio(value: Auth.signin, groupValue: _auth, onChanged: (Auth? val){
                setState(() {
                  _auth = val!;
                });
              }),
